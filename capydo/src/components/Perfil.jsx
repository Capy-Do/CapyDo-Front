...
const [educationLevel, setEducationLevel] = useState("Superior");
const [institutionName, setInstitutionName] = useState("Universidad Nacional de San Rafael");
...
useEffect(() => {
    ...
    if (savedData) {
        ...
        setFullName(userData.fullName || "Nombre y Apellido");
        setRole(userData.role || "Rol");
        setUserName(userData.userName || "nombreUsuario");
        setMail(userData.mail || "nombre@mail.com");
        setEducationLevel(userData.educationLevel || "Superior");
        setInstitutionName(userData.institutionName || "Universidad Nacional de San Rafael");
        setBiography(userData.biography || 'Aquí va tu biografía. ✏️');
        // También deberías manejar la foto de perfil si la guardaste
    }
}, []);
    ...
    <div className="app">
        <div className="container-profile-card">
            ...
            <div className="profile-header">
                <img src={FotoPerfil8} alt="" className="profile-image"/>            
            </div>
...
<div className="container-biography">
    {/* Información de usuario y botón de edición */}
        <div className="profile-header-section">
            ...
            <button className="edit-btn" onClick={() => navigate('/personalizar-perfil')}>
